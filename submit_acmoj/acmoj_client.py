...
# -*- coding: utf-8 -*-
"""
ACMOJ API Client Command Line Tool - Git/Code Submission Version v2.3
...
2. Submit Code File:
   ...
   Reads the file and submits its contents directly.
...
def main():
    ...
    submit_file_parser.add_argument("--language", type=str, default="c++", help="Language (default: c++)")
